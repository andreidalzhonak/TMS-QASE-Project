...
public class DropDownListTestRuns {
    private static final String LIST_XPATH = "//div[@class='row']//label[text() = '%s']//parent::div//input[@type = 'text']";
    private static final String OPTION_XPATH = "//div[@id='layout']/div[6]//div//div//div";
    private static final String LIST_XPATH_SUITES = "//p[text() ='%s']";
    private static final String OPTION_XPATH_SUITES_CHECKBOX = "//p[text() ='%s']//parent::div//span";
    ...
    public void selectOptionInListTestSuite(String option) {
        ...
        String optionFinalXpath = String.format(OPTION_XPATH_SUITES_CHECKBOX, option);
        driver.findElement(By.xpath(optionFinalXpath)).click();
    }
}